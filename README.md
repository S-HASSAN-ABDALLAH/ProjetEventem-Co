...
![Accueil Mobile Lighthouse](./acceuil-version-mobile-lighthouse.png)

### ✅ Accueil - version desktop

![Accueil Desktop Lighthouse](./acceuil-version-desktop-lighthouse.png)
...
![Maquette Figma](./Maquettes/maquette-figma-accueil.png) 
![Maquette Figma](./Maquettes/maquette-figma-programme.png) 
![Maquette Figma](./Maquettes/maquette-figma-contact.png) 
...
- Contact : ![Contact Wireframe Mobile](./Maquettes/wireframe-contact-balsamiq-version-mobile.png)
...
![Résultat contraste](./contrast-checker-result.png)
